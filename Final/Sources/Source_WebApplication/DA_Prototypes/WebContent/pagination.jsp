...
<%
		...
		<table id="paggingAll">
			<tr>
			  <td class="pagination-label itemsMed" nowrap="nowrap">
			  ...
			  <td>
			  	...
			  	style="width: 10px;" maxlen="1" value="<%=pagination.getPage_number()%>" type="text" onchange="fnPagination(7,<%=pagination.getTotal_pages()%>);" number="true/></td>
