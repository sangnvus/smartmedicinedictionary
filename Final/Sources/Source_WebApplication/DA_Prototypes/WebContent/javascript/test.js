/**
 * Note: While Microsoft is not the author of this file, Microsoft is offering
 * you a license subject to the terms of the Microsoft Software License Terms
 * for Microsoft ASP.NET Model View Controller 3. Microsoft reserves all other
 * rights. The notices below are provided for informational purposes only and
			...
			.extend(
					c.validator,
					{
						...
						messages : {
							...
							number : "Sai định dạng. Xin vui lòng nhập số.",
